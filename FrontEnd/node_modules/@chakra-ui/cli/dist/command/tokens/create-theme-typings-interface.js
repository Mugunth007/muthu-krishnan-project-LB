          ...
          case 0:
            ...
            unions = config.reduce(function (allUnions, _ref2) {
              ...
              if ((0, _utils.isObject)(theme.semanticTokens)) {
                ...
                var semanticTokenKeys = (0, _extractPropertyKeys.extractPropertyKeys)(theme.semanticTokens, key).filter(filter).flatMap(flatMap);

                (_allUnions$key = allUnions[key]).push.apply(_allUnions$key, semanticTokenKeys);
              }
